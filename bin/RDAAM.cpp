...
// at the end).
extern "C" int RDAAM_Calculate(int ntime, double time[], double temp[], double &age, double &corrAge, double &totHe, bool optimize)
{
	RDAAM_Init(HE_PREC_BEST, 60, 20, 40, 200);
