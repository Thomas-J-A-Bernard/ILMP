...
void ketch_main(int ntime, float ketchtime[], float ketchtemp[], double alo, double kinetic_par, double *final_age, double *oldest_age, double fmean[], double fdist[])
{
    ...
    kinpar = ETCH_PIT_LENGTH; /* CL_WT_PCT */
